...
?>
<?php
$con=mysqli_connect("sg2plcpnl0056.prod.sin2.secureserver.net","nail_user","nail_pass","nail_db");
...
while($row2 = mysqli_fetch_array($result2)) { 	
	...
	<p class="profile_logout">Log Out</p>
		...
		<div class="col-sm-9 your-notes top-background">
	...
	<p class="note1_busm1">Business and Man....</p>
		...
		<div class="container">
	<div class="col-sm-2">
	<div class="notes1_internal1"></div>
	<p class="note1_internal1">Internal Assesment</p>
	</div>
	<div class="col-sm-2">
	<div class="notes1_internal1"></div>
	<p class="note1_internal1">Internal Assesment</p>
	...
	<div class="col-sm-1">
	<div class="notes1_internal1"></div>
	<p class="note1_internal2">Internal Assesment</p>
	<?php 
	...
	while($row = mysqli_fetch_array($result)) { 
	  ...
	  echo "Internal Assesment";
	   echo "&nbsp;&nbsp;&nbsp;";
	   echo "<td><a href=\"pdf_file.php?id=$row[id]\"><button>View</button></a> 
		</td>";	
	}
	?>
	</div>
