...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			header('Location: about.php?action=resetAccount');
			exit;
...
<body>
	...
	<div class="wrap col-12">
        ...
        <!--end header-->
		<div class="col-sm-12 resetpasschange">
			<div class="container">
			<?php if(isset($stop)){
			...
			<?php
				...
				<div class="col-sm-12 col-lg-12 col-md-12 moble-col-9 resetyourpass">
					...
					<div class="col-12">
                           <div class="formrestpass">
                                <label>Enter New Password</label> 
                               <input type="text" name="password" class="inp-ourchangepas">
                           </div>
                        </div>
								<div class="col-12">
                           <div class="formrestpass">
                                <label>Confirm New Password</label> 
                               <input type="text" name="passwordConfirm" class="inp-ourchangepas">
                           </div>
                        </div>
						<input type="submit" name="submit" class="buttonchangep" value="Change Password">
			</div>
			</form>
